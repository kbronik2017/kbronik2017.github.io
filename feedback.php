...
$formurl = "http://ultimatescientificcomputing.com/contact/index.html" ;
...
$email = $_POST['email'] ;
$url = $_POST['url'] ;
$subscribe_comments = $_POST['subscribe_comments'] ;
$subscribe_blog = $_POST['subscribe_blog'] ;
...
$messageproper =
	...
	"Website of sender: $url" . $content_nl .
        "Follow-up comments by email.: $subscribe_comments" . $content_nl .
        "New posts by email: $subscribe_blog" . $content_nl .
