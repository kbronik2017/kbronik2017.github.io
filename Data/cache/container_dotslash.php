...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'Data_oauth_tokens', 'Data_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'Data_users', $this, './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'Data_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'Data_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'Data_forums', 'Data_posts', 'Data_topics', 'Data_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('Data_captcha_questions', 'Data_captcha_answers', 'Data_qa_confirm');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('ultimateprogrammer.co.uk.mysql', 'ultimateprograk', 'BLTUSyTQ', 'ultimateprograk', '', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'Data_ext', './', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'Data_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'Data_migrations', './', 'php', 'Data_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'Data_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './', 'php', 'Data_notification_types', 'Data_notifications', 'Data_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'Data_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'Data_profile_fields', 'Data_profile_lang', 'Data_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'Data_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'Data_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'Data_oauth_accounts',
            'tables.captcha_qa_questions' => 'Data_captcha_questions',
            'tables.captcha_qa_answers' => 'Data_captcha_answers',
            'tables.captcha_qa_confirm' => 'Data_qa_confirm',
            'tables.config' => 'Data_config',
            'tables.config_text' => 'Data_config_text',
            'tables.ext' => 'Data_ext',
            'tables.forums' => 'Data_forums',
            'tables.log' => 'Data_log',
            'tables.migrations' => 'Data_migrations',
            'tables.modules' => 'Data_modules',
            'tables.notification_types' => 'Data_notification_types',
            'tables.notifications' => 'Data_notifications',
            'tables.profile_fields' => 'Data_profile_fields',
            'tables.profile_fields_data' => 'Data_profile_fields_data',
            'tables.profile_fields_options_language' => 'Data_profile_fields_lang',
            'tables.profile_fields_language' => 'Data_profile_lang',
            'tables.posts' => 'Data_posts',
            'tables.topics' => 'Data_topics',
            'tables.user_notifications' => 'Data_user_notifications',
            'tables.users' => 'Data_users',
            ...
            'core.table_prefix' => 'Data_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysqli',
            'dbal.dbhost' => 'ultimateprogrammer.co.uk.mysql',
            'dbal.dbuser' => 'ultimateprograk',
            'dbal.dbpasswd' => 'BLTUSyTQ',
            'dbal.dbname' => 'ultimateprograk',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
